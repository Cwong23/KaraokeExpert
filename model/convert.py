...
y_mix, sr_mix = librosa.load(SOURCE_FILE, sr=SR)  # Load directly at 44.1k
...
mix_input = mix_spec[:1024, :]  # Crop height to 1024
...
pred_npy = full_pred[:, :original_w]  # Remove padding
final_pred_npy = np.vstack(
    [pred_npy, np.zeros((1, original_w))])  # Add back 1025th bin
